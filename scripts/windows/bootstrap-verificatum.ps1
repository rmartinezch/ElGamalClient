param(
    ...
    [string]$JavaHome,
    [string]$MavenCmd,
    [string]$VcrSourceRoot = "D:\_Proyectos\mixnet\verificatum-vcr-3.1.0",
    [string]$VecjSourceRoot = "D:\_Proyectos\mixnet\verificatum-vecj-2.2.0",
    [string]$VmgjJarPath = "C:\Users\soett\verificatum-vmn-3.1.0-full\verificatum-vmgj-1.3.0\verificatum-vmgj-1.3.0.jar"
)
