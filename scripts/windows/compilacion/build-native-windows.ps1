...
$VecSourcePath = Resolve-PreferredPath `
    ...
    -Candidates @(
        (Join-Path $ProjectRoot "native\verificatum-src\verificatum-vec-$VecVersion"),
...
$GmpmeeSourcePath = Resolve-PreferredPath `
    ...
    -Candidates @(
        (Join-Path $ProjectRoot "native\verificatum-src\verificatum-gmpmee-$GmpmeeVersion"),
...
$VecjSourcePath = Resolve-PreferredPath `
    ...
    -Candidates @(
        (Join-Path $ProjectRoot "native\verificatum-src\verificatum-vecj-$VecjVersion"),
...
$VmgjSourcePath = Resolve-PreferredPath `
    ...
    -Candidates @(
        (Join-Path $ProjectRoot "native\verificatum-src\verificatum-vmgj-$VmgjVersion"),
...
$WindowsNativeRoot = Join-Path $ProjectRoot "prebuilt\windows-x64"
