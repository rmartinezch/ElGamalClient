...
JNILIBS_ROOT="$ANDROID_DIR/app/src/main/jniLibs"
...
resolve_source_root() {
  ...
  echo "[build-jni] Defina VERIFICATUM_SOURCE_ROOT o use \$HOME/mixnet." >&2
  exit 1
}
...
echo "[build-jni] OK: bibliotecas JNI sincronizadas en $JNILIBS_ROOT"
